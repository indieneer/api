...
def update_profile(profile_id: str):
    ...
    This endpoint allows for the partial update of a user profile.
    It requires authentication and permits only the owner of the profile to make updates.
    The function raises exceptions if the invoker's ID does not match the profile ID.

    :param str profile_id: The ID of the profile to be updated.
    :raises NotFoundException: If the profile was not found.
    :return: The updated profile in JSON format.
    :rtype: dict
    """
