...
from app.models.products import Product, Media, Requirements, ReleaseDate
...
class ProductCommentTestCase(UnitTest):
    ...
    def test_create_product_comment(self, db: MagicMock):
        ...
        def creates_and_returns_a_product_comment():
            ...
            collection_mock = mock_collection(db, 'product_comments')
            collection_mock.insert_one.return_value = mock_product_comment.to_json()
