...
class TagsTestCase(IntegrationTest):
    @property
    def token(self):
        return self.models.logins.login(email="test_integration+admin@pork.com",
    ...
    def test_get_tags_with_not_admin_token(self):
        # given
        token = self.models.logins.login(email="test_integration+regular@pork.com",
                                         password="9!8@7#6$5%4^3&2*1(0)-_=+[]{}|;:")["access_token"]
    ...
    def test_get_tag_by_id_not_found(self):
        ...
        self.assertEqual(response_json["error"], f"The tag with ID {id} was not found.")
    ...
    def test_update_token_with_invalid_keys(self):
        ...
        # then
        self.assertEqual(response.status_code, 422)
        self.assertEqual(response_json["error"], "The keys ['description'] are not allowed.")
    ...
    def test_delete_tag(self):
        ...
        # then
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response_json["data"], f"Successfully deleted the tag with ID {tag._id}")
