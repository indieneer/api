...
class UnitTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.fixtures = Fixtures(
            regular_user=
            self.factory.profiles.create(ProfileCreate("test_integration+regular@pork.com", self.strong_password))[0],
            admin_user=
            self.factory.profiles.create_admin(ProfileCreate("test_integration+admin@pork.com", self.strong_password))[
                0],
